        ...
        'application/json': {
          schema: z.array(
            z.object({
              ...
              roastLevel: z.enum(['light', 'medium', 'medium_dark', 'dark']).openapi({ description: '원두 로스팅 정도' }),
            }),
          ),
        },
      },
      ...
      content: {
        'application/json': {
          schema: z.object({
            ...
            roastLevel: z.enum(['light', 'medium', 'medium_dark', 'dark']).optional().openapi({ description: '원두 로스팅 정도' }),
          }),
        },
      },
    },
